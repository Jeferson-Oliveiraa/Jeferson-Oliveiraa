...
- 🔧 **Ferramentas e Tecnologias:** Visual Studio | Visual Studio Code | Pycharm | SQLite | MySql | Postan | REST APIs Flask | CSS | HTML | Oracle SQL | SoapUI | Jira | Monday | SharePoint | Citrix 
...
![Snake animation](https://github.com/Jeferson-Oliveiraa/blob/output/github-contribution-grid-snake.svg)
