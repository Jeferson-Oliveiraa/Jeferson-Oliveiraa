...
- 🔧 **Ferramentas e Tecnologias:** Visual Studio | Visual Studio Code | Pycharm | SQLite | MySql | Postman | REST APIs Flask | CSS | HTML | Oracle SQL | SoapUI | Jira | Monday | SharePoint | Citrix 
